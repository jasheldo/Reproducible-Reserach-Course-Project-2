...
barplot(small$FATALITIES[1:5], names.arg = small$EVTYPE[1:5], col = c("blue", "red", "green", "yellow", "orange"), xlab = "Event Type", ylab = "Total Fatalities Since 1/1/1993", main = "Top 5 Events by Fatalities Since 1/1/1993", cex.names = 0.5)
```
...
barplot(esmall$econ[1:5], names.arg = esmall$EVTYPE[1:5], col = c("blue", "red", "green", "yellow", "orange"), xlab = "Event Type", ylab = "Total Economic Impact Since 1/1/1993 (in billions)", main = "Top 5 Events by Economic Impact Since 1/1/1993", cex.names = 0.5)
```
